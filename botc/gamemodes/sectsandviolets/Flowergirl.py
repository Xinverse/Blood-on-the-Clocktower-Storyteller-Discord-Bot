...
class Flowergirl(Townsfolk, SectsAndViolets, Character):
    ...
    def __init__(self):
        ...
        self._art_link = "http://bloodontheclocktower.com/wiki/images/d/de/Flowergirl_Token.png"
        self._wiki_link = "http://bloodontheclocktower.com/wiki/Flowergirl"
